export default function welcomeHtml(trimmedName,course, leadId){
    const openPixel = `${process.env.NEXT_PUBLIC_APP_URL}/api/email/track/open?leadId=${leadId}&course=${course}`;
    const callLink = `${process.env.NEXT_PUBLIC_APP_URL}/api/email/track/click?leadId=${leadId}&action=call&course=${course}`;
    const whatsappLink = `${process.env.NEXT_PUBLIC_APP_URL}/api/email/track/click?leadId=${leadId}&action=whatsapp&course=${course}`;
    const websiteLink = `${process.env.NEXT_PUBLIC_APP_URL}/api/email/track/click?leadId=${leadId}&action=website&course=${course}`;
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td align="left" style="font-size: 12px; color: #9ca3af; line-height: 1.6;">
                                        ...
                                        <a href="https://www.grras.com/" style="color: ${primaryColor}; text-decoration: none;">www.grras.com</a><br>
